...
def create_excel_file(file_name):
    ...
    try:
        ...
        for row_num in range(2, 1002):  # Adjust the range based on your actual requirements
...
def add_data(file_name, sheet_name):
    if request.method == 'POST':
        # Handle form submission and add data to the sheet
        # ...
        print()

    return render_template('add_data_form.html', file_name=file_name, sheet_name=sheet_name)
